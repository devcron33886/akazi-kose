    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="grid grid-cols-3 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4">
            <div class="border border-white rounded-md py-4 px-4">
                ...
                <ul class="mt-4">
                    <li class="text-white">Address: {{ $settings->address }}</li>
                    <li class="text-white">Phone: {{ $settings->phone }}</li>
                    <li class="text-white">Whatsapp: {{ $settings->whatsapp }}</li>
                    <li class="text-white">E-mail: {{ $settings->email }}</li>
                </ul>
            </div>
            ...
            <div class="border border-white rounded-md px-4 py-4">
                ...
                <ul class="mt-4">
                    ...
                    <li><a href="{{ route('employers') }}" wire:navigate
                            class="text-white hover:text-black">Employers</a></li>
                    <li><a href="#" class="text-white hover:text-black">About us</a></li>
                    <li><a href="{{ route('contact.index') }}" wire:navigate class="text-white hover:text-black">Contact
                            us</a></li>
