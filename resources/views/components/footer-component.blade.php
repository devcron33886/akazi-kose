        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="border border-white rounded-md px-4 py-4">
                ...
                <ul class="mt-4">
                    ...
                    <li class="py-2">
                        <a href="{{ route('about-us') }}" class="text-white hover:text-black" wire:navigate>About us</a>
                    </li>
                    <li class="py-2">
                        <a href="{{ route('contact.index') }}" wire:navigate class="text-white hover:text-black">Contact
                            us</a>
                    </li>
                    <li class="py-2">
