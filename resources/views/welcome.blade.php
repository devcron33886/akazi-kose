                    ...
                    <div class="mt-4 sm:px-4">
                        <div class="flex flex-col bg-white border border-blue-500 rounded-lg px-4 py-2 md:flex-row sm:flex-row">
                            <div class="md:mr-4 mb-2 md:mb-0">
                                <img src="/storage/{{ $advert->institution->logo ?? '-' }}" alt="{{ $advert->institution->name ?? '-' }}" class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg">
                            </div>
                            <div class="flex-1">
