        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between h-16 lg:h-20">
                <div class="hidden lg:flex lg:items-center lg:space-x-10">
                    <a href="{{ route('home') }}" title="" class="text-base font-medium text-black"> Home </a>

                    <a href="{{ route('employers') }}" wire:navigate title=""
                        class="text-base font-medium text-black"> Employers </a>
